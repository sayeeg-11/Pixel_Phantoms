...
function showProgressFallback(containerId) {
  ...
  container.innerHTML =
    '<div class="progress-bar" style="width: 0%; height: 20px; background: var(--accent-color); border-radius: 4px; transition: width 0.3s;"></div>';
...
function initializeShareButtonIfAvailable() {
  ...
  if (
    !document.querySelector('script[src*="share-button.js"]') &&
    typeof window.shareButton === 'undefined'
  ) {
