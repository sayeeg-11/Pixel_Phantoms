...
class ActivityTimeline {
    ...
    const mockActivities = [
      {
        ...
        description:
          'Started contributing to the AI neural network visualization tool. Working on real-time data processing module.',
        date: '2024-01-15',
        timeAgo: '3 days ago',
        points: 250,
      ...
      },
      {
        ...
        description:
          'Participated in 48-hour coding marathon. Built a real-time cybersecurity dashboard with team "CyberSentinels".',
        date: '2024-01-12',
        timeAgo: '6 days ago',
        points: 500,
      ...
      },
      {
        ...
        description:
          'Improved the leaderboard visualization with 3D effects and better mobile responsiveness. Added touch-friendly interactions.',
        date: '2024-01-10',
        timeAgo: '1 week ago',
        points: 300,
        prNumber: '#42',
      ...
      },
      {
        ...
        description:
          'Successfully identified and fixed 10 critical bugs across different projects. Awarded for exceptional debugging skills.',
        date: '2024-01-05',
        timeAgo: '2 weeks ago',
        points: 1000,
      ...
      },
      {
        ...
        description:
          'Finished all onboarding modules for the quantum computing simulation platform. Ready to start contributing to core algorithms.',
        date: '2024-01-01',
        timeAgo: '3 weeks ago',
        points: 150,
  ...
  renderTimeline() {
    ...
    if (this.currentFilter !== 'all') {
      filteredActivities = this.activities.filter(activity => activity.type === this.currentFilter);
    }
