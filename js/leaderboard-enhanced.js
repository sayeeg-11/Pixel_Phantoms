...
const HOME_ACHIEVEMENTS = [
  ...
  },
  {
    id: 'streak_master',
    name: 'Streak Master',
    description: 'Contributed for 7 days straight',
    icon: 'fas fa-fire',
  },
  {
    id: 'community_champion',
    name: 'Community Champion',
    description: 'Helped 5 other contributors',
...
function openHomeModal(contributor) {
  ...
  document.getElementById('home-modal-league-badge').textContent =
    getClassLabel(contributor.class) || 'Contributor';
